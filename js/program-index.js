  ...
  monday_am: {
    ...
    blocks: [
      ...
      },
      {
        id: "shoulder-er-pos1",
        type: "shoulder_er",
        name: "Shoulder ER — Side-lying DB",
        prescriptions: {
  ...
  tuesday: {
    ...
    blocks: [
      ...
      },
      {
        id: "shoulder-er-pos2",
        type: "shoulder_er",
        name: "Shoulder ER — Prone @ 90° abd",
        prescriptions: {
          1: { position: 2, load_kg: 4, sets: 2, reps: 10 },
          2: { position: 2, load_kg: 6, sets: 2, reps: 10 },
          3: { position: 2, load_kg: 8, sets: 2, reps: 10 },
          4: { position: 2, load_kg: 7, sets: 2, reps: 8 },
        },
      },
    ],
  },
  ...
  wednesday_am: {
    ...
    blocks: [
      ...
      },
      {
        id: "shoulder-er-pos4",
        type: "shoulder_er",
        name: "Shoulder ER — Half-kneeling 90° flexion",
        prescriptions: {
          1: { position: 4, load_kg: 4, sets: 2, reps: 10 },
          2: { position: 4, load_kg: 6, sets: 2, reps: 10 },
          3: { position: 4, load_kg: 8, sets: 2, reps: 10 },
          4: { position: 4, load_kg: 7, sets: 2, reps: 8 },
        },
      },
    ],
  },
